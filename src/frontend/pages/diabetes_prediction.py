...
if st.button("🔍 Predict",  use_container_width=True):
    ...
    result = response.json() #output in json is converted into dictionary
    ...
    if prediction == 1:
        st.error("⚠️ Models Predicted: Diabetes")

    else:

        st.write("✅ Model Prediction: No Diabetes")



# to run this code: streamlit run src/frontend/pages/diabetes_prediction.py
